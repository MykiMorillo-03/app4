...
<body>
    ...
    <header class="content header">
        ...
        <p>
          Leyendas de motores en cuatro ruedas a buen precio.
        </p>
    ...
    <section class="content sau">
        ...
        <p>Año de lanzamiento: 1978
            ...
            se presenta como el resurgir de una de las leyendas automotrices más importantes de la historia. Su retorno representa, además, un gran cambio para el modelo, ya que ha sido
            desarrollado y concebido en una colaboración sin precedentes entre Toyota y BMW.Ambas compañías acordaron hace tiempo aunar sus esfuerzos en el desarrollo de dos vehículos 
            deportivos, cada uno comercializado bajo su propia marca, pero sin compartir tantos atributos como los que comparten dos modelos similares: el Toyota GT86 y el Subaru BRZ. 
            Estos dos pequeños coupés deportivos comparten chasis, diseño, motorizaciones y la mayoría de su tecnología, lo cual no aporta ese gen diferenciador de cada uno de los 
            fabricantes. De este modo, Toyota y BMW acordaron su colaboración, aunque ambos modelos serían totalmente diferentes a simple vista.</p>
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>Un proyecto que dio vida a uno de los coches más deseados del planeta, del que solo se produjeron 349 unidades (en deferencia con la filosofía de Drake: "Ferrari 
                    ...
                    V12 (a 65°) de 4,7 litros capaz de ofrecer 520 CV de potencia a 8.500 vueltas y 471 Nm de par a 6.500 rpm, el aspecto de este Ferrari es, simplemente, sobrecogedor.</p>
            </div>
            <div class="box">
    ...
    <section class="content about">
        ...
        <p>Empresa dedicada a la venta de reliquias de cuatro ruedas bien conservados a precio economico con garantias de un año.
        </p>
    ...
    <section class="content price">
        ...
        <article class="contain">
            ...
            <p>
            Toyota Supra  ----  S/.66,267
            </p>
            <p>
            Nissan Skyline r34  ----  S/1,913,082
            </p>
            <p>
            Ferrari F50  ----  S/7,940,000.00
            </p>
            <p>
            Lamborghini Countach  ----  S/11,910,000
            </p>
